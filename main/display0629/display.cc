...
void Display::SetUIStyle(UIStyle style)
{
}
...
//     switch(style) {
//         case UIStyle::WeChat:
//             factory_ = std::make_unique<WeChatUIFactory>();
//             break;
//         case UIStyle::GIF:
//             factory_ = std::make_unique<GifUIFactory>();
//             break;
//         default:
//             factory_ = std::make_unique<MinimalUIFactory>();
//     }
//     rebuildUI();
// }
